# このコードはJulia 1.90で動作します。
# GPUなしでは非常に遅い。30分/epoch以上かかる。コードでは20epochつまり10時間かかる。
# 元コード dcgan_mnist.jl　https://github.com/FluxML/model-zoo/blob/master/vision/dcgan_mnist/dcgan_mnist.jl
# 2023/5/13 河野保　確認
